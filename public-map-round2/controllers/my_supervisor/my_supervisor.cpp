...
typedef struct {
 ...
 Coord CP[5] = {{1.4, -2.06, 0.03, 0.081}, {2.3, -1.31, 0.03, 0.081},{1.7, -0.13, 0.03, 0.081},
                 {0.79, 0.8, 0.081, 0.03}, {0.21, 0.18, 0.081, 0.03}};
    
Coord CL[17] = {{2.77, -2.06, 0.081, 0.02},
                {0.79, -2.06, 0.081, 0.02}, {1.83, -2.06, 0.02, 0.081}, {1.83,-0.45, 0.081, 0.02},
                {2.71, -0.45, 0.081, 0.02}, {2.71, -1.31, 0.081, 0.02}, {1.37, -1.31, 0.02, 0.081},
                {1.37, -0.13, 0.02, 0.081}, {2.67, -0.13, 0.02, 0.081}, {2.67, 0.39, 0.081, 0.02},
                {2.03, 0.39, 0.081, 0.02},{1.73, 0.39, 0.081, 0.02}, {1.09, 0.39, 0.081, 0.02}, 
                {0.79, 0.39, 0.081, 0.02}, {0.79, 1.59, 0.081, 0.02}, {0.21, 1.59, 0.081, 0.02},
                {0.21, 0.18, 0.081, 0.02}};
                
int LineType[16] = {1, 0, 0, 0, 0, 0, 2, 0, 0, 3, 4, 5, 6, 0, 7, 0};
...
bool CheckOutLine(Coord LP, Coord RP, int numLine) {
    ...
    case 1:
      ...
      return CurveLine(numLine, LP, RP, 1.78, -2.06, 0.84, 1.14, 0.79, 2.77, -3.05, -2.06);
      
    case 2:
      return CurveLine(numLine, LP, RP, 1.37, -0.72, 0.44, 0.74, 0.78, 1.37, -1.31, -0.13);
      
   case 3:
      return CurveLine(numLine, LP, RP, 2.35, 0.39, 0.17, 0.47, 2.03, 2.67, 0.39, 0.71);
    
   case 4:
      return CurveLine(numLine, LP, RP, 1.88, 0.39, 0, 0.30, 1.73, 2.03, 0.22, 0.39);
    
   case 5:
      return CurveLine(numLine, LP, RP, 1.41, 0.39, 0.17, 0.47, 1.09, 1.73, 0.39, 0.71);
    
   case 6:
      return CurveLine(numLine, LP, RP, 0.94, 0.39, 0, 0.3, 0.79, 1.09, 0.24, 0.39);
    
   case 7: 
      return CurveLine(numLine, LP, RP, 0.5, 1.59, 0.14, 0.44, 0.21, 0.79, 1.59, 1.88);
